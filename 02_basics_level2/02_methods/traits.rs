...
fn main() {
    ...
    println!(
        "Struct size. Parrot: {}, Duck: {}",
        std::mem::size_of::<Parrot>(),
        std::mem::size_of::<Duck>()
    );
    println!(
        "Link size. Parrot: {}, Duck: {}",
        std::mem::size_of::<&Parrot>(),
        std::mem::size_of::<&Duck>()
    );
    println!(
        "Trait fat pointer size: {}",
        std::mem::size_of::<&dyn Pet>()
    );
