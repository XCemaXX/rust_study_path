use stack_from_second::Stack;

// The Double Singly-Linked List
mod stack_from_second;
...
mod test {
    ...
    fn walk_aboot() {
        ...
        while list.go_right() {} // [5, 4, 1, _]
        assert_eq!(list.pop_right(), None);
        assert_eq!(list.pop_left(), Some(1)); // [_, 4, 1]
        assert_eq!(list.pop_left(), Some(4)); // [_, 1]
        assert_eq!(list.pop_left(), Some(5)); // [_]
